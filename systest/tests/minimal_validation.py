                ...
                "jobs": [
                    {
                        "read": {
                            ...
                            "lat_ns": {
                                "mean": 100000,
                                "stddev": 50000,
                                "percentile": {"50.000000": 90000, "99.000000": 200000, "99.999000": 500000},
                            },
                        }
                    }
                ]
                ...
                "jobs": [
                    {
                        "write": {
                            ...
                            "lat_ns": {
                                "mean": 200000,
                                "stddev": 100000,
                                "percentile": {"50.000000": 180000, "99.000000": 400000, "99.999000": 800000},
                            },
                        }
                    }
                ]
...
def verify_report_generation():
    ...
    test_data = {
        ...
        "test_results": {
            ...
            "summary": {"total": 3, "passed": 2, "failed": 1, "errors": 0, "pass_rate": 66.7},
        },
        "system_info": {
            ...
            "test_cases": [
                {
                    ...
                    "status": "FAIL",
                    "metrics": {"latency_p50": 50.0, "latency_p99": 500.0, "latency_p99999": 8000.0, "latency_stddev": 1200.0},
                }
            ]
        },
        "config": {},
...
def verify_suite_loading():
    ...
    expected_tests = {"performance": 9, "qos": 2, "reliability": 1, "scenario": 2}
