...
修改记录：
    2026-03-18 QA Agent 初始版本，按 7 部分框架编写
    2026-03-18 QA Agent 重构：公共函数抽取到 test_helpers，脚本仅定义测试逻辑
"""
...
def main():
    ...
    success, output, error = run_fio(test_dir, FIO_PARAMS, job_name="seq_read_burst")
